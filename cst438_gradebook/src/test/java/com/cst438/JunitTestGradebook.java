...
public class JunitTestGradebook {
	...
	public void deleteAssignment() throws Exception {
		...
		response = mvc
				.perform(MockMvcRequestBuilders.delete("/assignment")).andReturn().getResponse();
	...
	@Test
	public void changeNameOfAssignment() throws Exception {
		...
		response = mvc
				.perform(MockMvcRequestBuilders.put("/assignment/1?name=test").accept(MediaType.APPLICATION_JSON))
				.andReturn().getResponse();
	...
	public void addAssignment() throws Exception {
		...
		response = mvc
				.perform(MockMvcRequestBuilders.put("/assignment/1?name=test&due_date=2023-02-28").accept(MediaType.APPLICATION_JSON))
				.andReturn().getResponse();
